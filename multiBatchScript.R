...
batchFiles    <- c("infoScenarios.bch","infoScenarios.bch","infoScenarios.bch","pubBase4MPs.bch")
baseCtlFiles  <- c("simCtlFileRP.txt","simCtlFileModelQ.txt","simCtlFile.txt","simCtlFile.txt")
